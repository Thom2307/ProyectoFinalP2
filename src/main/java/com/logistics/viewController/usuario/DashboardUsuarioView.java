...
public class DashboardUsuarioView {
    ...
    public Scene crearScene() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/usuario/dashboardusuario.fxml"));
            ...
            e.printStackTrace();
            throw new RuntimeException("Error al cargar dashboardusuario.fxml", e);
        }
    }
}
